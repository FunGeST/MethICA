...
component analysis to extract methylation signatures from bval data, as
well as functions to calculate associations with sample annotations and
CpG characteristics. The package also provides representations that
facilitate the interpretation of signatures. This document, paired with
the ``MethICA\_examples\_script.R'' demo script, outlines the typical
workflow for the analyis of thegenomic data from a series of tumours.
...
\includegraphics{Introduction-to-MethICA_files/figure-latex/pressure-1.pdf}
